...
void VisualDisplay::load(char *file_name)
{
    ...
    {
        char file_name[200];
        sprintf(file_name, "/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/%d.png", i+1);
        num_img[i] = imread(file_name);
        resize(num_img[i], num_img[i], Size(num_img[i].cols * ratio, num_img[i].rows * ratio));
        
        sprintf(file_name, "/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/%d_blue.png", i+1);
    ...
    open_bracket = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/open_bracket.png");
    close_bracket = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/close_bracket.png");
    ...
    button[0].org_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/radio_button.png"); //button  0 (backtrack)
    button[0].hov_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/radio_hover.png");
    button[0].clk_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/radio_select.png");
    ...
    button[3].org_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/checkbox_unchecked.png"); //random check button
    button[3].hov_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/checkbox_unchecked.png");
    button[3].clk_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/checkbox_checked.png");
    ...
    button[4].org_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/checkbox_unchecked.png"); //domain show check button
    button[4].hov_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/checkbox_unchecked.png");
    button[4].clk_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/checkbox_checked.png");
    ...
    button[5].org_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/checkbox_unchecked.png"); //ordering check button
    button[5].hov_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/checkbox_unchecked.png");
    button[5].clk_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/checkbox_checked.png");
    ...
    button[6].org_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/next.png"); //next button (move one step forward)
    button[6].hov_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/next_hover.png");
    button[6].clk_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/next.png");
    ...
    button[7].org_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/back.png"); //back button  (move one step backward)
    button[7].hov_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/back_hover.png");
    button[7].clk_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/back.png");
    ...
    go_btn.org_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/go.png"); //next button 0 (move one step forward)
    go_btn.hov_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/go_hover.png");
    go_btn.clk_img = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/pause_hover.png");
    ...
    go_btn.org_img_2 = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/pause.png"); //next button 0 (move one step forward)
    go_btn.hov_img_2 = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/pause_hover.png");
    go_btn.clk_img_2 = imread("/Users/kanishk/Desktop/sud/si1/Sudoku_Source_Files_Only/imgs/go_hover.png");
...
void VisualDisplay::paintButtons()
{
    ...
    /*Render the labels*/
    cv::putText(sudoku_img, "Back Track", Point(button[0].top_let.x + 40, button[0].top_let.y + 14), FONT_HERSHEY_COMPLEX_SMALL, 0.8, Scalar(50, 50, 50), 1, LINE_AA);
    cv::putText(sudoku_img, "Forward Check", Point(button[1].top_let.x + 40, button[1].top_let.y + 14), FONT_HERSHEY_COMPLEX_SMALL, 0.8, Scalar(50, 50, 50), 1, LINE_AA);
    cv::putText(sudoku_img, "Arc Consistency", Point(button[2].top_let.x + 40, button[2].top_let.y + 14), FONT_HERSHEY_COMPLEX_SMALL, 0.8, Scalar(50, 50, 50), 1, LINE_AA);
    cv::putText(sudoku_img, "Random Value", Point(button[3].top_let.x + 40, button[3].top_let.y + 14), FONT_HERSHEY_COMPLEX_SMALL, 0.8, Scalar(50, 50, 50), 1, LINE_AA);
    cv::putText(sudoku_img, "Show Domain", Point(button[4].top_let.x + 40, button[4].top_let.y + 14), FONT_HERSHEY_COMPLEX_SMALL, 0.8, Scalar(50, 50, 50), 1, LINE_AA);
    cv::putText(sudoku_img, "Ordering", Point(button[5].top_let.x + 40, button[5].top_let.y + 14), FONT_HERSHEY_COMPLEX_SMALL, 0.8, Scalar(50, 50, 50), 1, LINE_AA);
...
void VisualDisplay::paintContainer()
{
    ...
    /*Render Goal Found*/
    if(goal_found == true)
        cv::putText(sudoku_img, "Goal is Found!!!", Point(sudoku_blank.cols * .4, sudoku_blank.rows * .4), FONT_HERSHEY_COMPLEX_SMALL, 2.2 , Scalar(0, 200, 0), 3, LINE_AA);
